...
Abstractive Git is a VS Code extension scaffold for IntelliJ-inspired Git and SCM workflows.
...
- A bottom-panel Git tool window for branch -> commit -> file -> live diff preview navigation.
